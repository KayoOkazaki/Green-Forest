        ...
        <div class="mainimg">
            <div class="intro_a">
              ...
              <p>Welcome to Green Forest!<br>
                ...
                <a class="buttn" href="contact.html"><span>ご予約はこちら</span></a>
              </p>
            </div>
        </div>
        <div id="globalNavi">
                    ...
                    <article id="blog01">
                        ...
                        <div class="wrapper">
                           ...
                           足には血行をよくする為のツボがたくさんあります。足をマッサージする事によりある程度のむくみは解消する事ができます。
                            ...
                            <div class="image"><img src="images/trouble01-150x150.jpg"></div>
                        </div>
                    </article>
                    <article id="blog02">
                        <h3>首の痛み</h3>
                        <div class="wrapper">
                            ...
                            <div><img src="images/trouble02-150x150.jpg"></div>
                        </div>
                    </article>
                    <article id="blog03">
                        <h3>肩こり</h3>
                        <div class="wrapper">
                            ...
                            <div><img src="images/trouble03-150x150.jpg"></div>
                        </div>
                    </article>
                    <article id="blog04">
                        <h3>心の風邪</h3>
                        ...
                        <a href="first.html#aboutus02">心の風邪にはフラワーエッセンスがお勧め！</a></p>
                            <div><img src="images/trouble04-150x150.jpg"></div>
                        </div>
                    </article>
                </section>
            </div>
